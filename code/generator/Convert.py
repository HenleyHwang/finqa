...
if __name__ == '__main__':
    ...
    ## BERT retriever
    json_in = root + "output/inference_only_20240505232937_retriever-bert-base-inference-train/results/test/predictions.json"
    json_out = root + "dataset/train-retrieve-bert-base.json"
    convert_train(json_in, json_out, topn=3, max_len=290)

    json_in = root + "output/inference_only_20240505233018_retriever-bert-base-inference-dev/results/test/predictions.json"
    json_out = root + "dataset/dev-retrieve-bert-base.json"
    convert_train(json_in, json_out, topn=3, max_len=290)

    json_in = root + "output/inference_only_20240505233034_retriever-bert-base-inference-test/results/test/predictions.json"
    json_out = root + "dataset/test-retrieve-bert-base.json"
    convert_train(json_in, json_out, topn=3, max_len=290)

    # ## RoBERTa retriever
    # json_in = root + "output/inference_only_20240507010448_retriever-roberta-base-inference-train/results/test/predictions.json"
    # json_out = root + "dataset/train-retrieve-roberta-base.json"
    # convert_train(json_in, json_out, topn=3, max_len=290)

    # json_in = root + "output/inference_only_20240507010357_retriever-roberta-base-inference-dev/results/test/predictions.json"
    # json_out = root + "dataset/dev-retrieve-roberta-base.json"
    # convert_train(json_in, json_out, topn=3, max_len=290)
    
    # json_in = root + "output/inference_only_20240507010313_retriever-roberta-base-inference-test/results/test/predictions.json"
    # json_out = root + "dataset/test-retrieve-roberta-base.json"
    # convert_train(json_in, json_out, topn=3, max_len=290)
